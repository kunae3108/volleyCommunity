...
<head> 
	...
	<title>volleyCommunity - volleyBall Social Community</title> 
	<link href="<c:url value='/static/resources/css/bootstrap.min.css'/>" rel="stylesheet">
	<link href="<c:url value='/static/resources/css/prettyPhoto.css'/>" rel="stylesheet"> 
	<link href="<c:url value='/static/resources/css/font-awesome.min.css'/>" rel="stylesheet"> 
	<link href="<c:url value='/static/resources/css/animate.css'/>" rel="stylesheet"> 
	<link href="<c:url value='/static/resources/css/main.css'/>" rel="stylesheet">
	<link href="<c:url value='/static/resources/css/responsive.css'/>" rel="stylesheet"> 
	<!--[if lt IE 9]> <script src="<c:url value='/static/resources/js/html5shiv.js'/>"></script> 
	<script src="<c:url value='/static/resources/js/respond.min.js'/>"></script> <![endif]--> 
	<link rel="shortcut icon" href="<c:url value='/static/resources/images/ico/favicon.png'/>"> 
	<link rel="apple-touch-icon-precomposed" sizes="144x144" href=" <c:url value='/static/resources/images/ico/apple-touch-icon-144-precomposed.png'/>"> 
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href=" <c:url value='/static/resources/images/ico/apple-touch-icon-114-precomposed.png'/>"> 
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href=" <c:url value='/static/resources/images/ico/apple-touch-icon-72-precomposed.png'/>"> 
	<link rel="apple-touch-icon-precomposed" href=" <c:url value='/static/resources/images/ico/apple-touch-icon-57-precomposed.png'/>">
</head>
<div class="preloader">
		...
		<div class="navbar navbar-inverse navbar-fixed-top" role="banner"> 
			<div class="container"> 
				<div class="navbar-header"> 
					...
					<a class="navbar-brand" href="index.html"><h1><img src="<c:url value='/static/resources/images/logo.png'/>" alt="logo"></h1></a> 
				</div> 
	...
	<section id="home">
		...
		<div id="main-carousel" class="carousel slide" data-ride="carousel"> 
			...
			<div class="carousel-inner">
				<div class="item active" style="background-image: url(${pageContext.request.contextPath}/static/resources/images/slider/slide3.jpg)"> 
				...
				<div class="item" style="background-image: url(${pageContext.request.contextPath}/static/resources/images/slider/slide2.jpg)"> 
			...
			<div class="item" style="background-image: url(${pageContext.request.contextPath}/static/resources/images/slider/slide1.jpg)"> 
				<div class="carousel-caption"> 
					<div> 
...
<section id="about-us">
				...
				<div class="col-sm-6">
					...
					<div class="tab-content">
						<div class="tab-pane fade in active" id="about">
							<div class="media">
								<img class="pull-left media-object" src=" <c:url value='/static/resources/images/about-us/about.jpg'/>" alt="about us"> 
						...
						<div class="tab-pane fade" id="mission">
							<div class="media">
								<img class="pull-left media-object" src=" <c:url value='/static/resources/images/about-us/mission.jpg'/>" alt="Mission"> 
								<div class="media-body">
						...
						<div class="tab-pane fade" id="community">
							<div class="media">
								<img class="pull-left media-object" src="<c:url value='/static/resources/images/about-us/community.jpg'/>" alt="Community"> 
								<div class="media-body">
						...
						<div class="row item active">
							<div class="col-sm-6 col-md-3">
								<div class="single-member">
									<img src="<c:url value='/static/resources/images/our-team/member1.jpg'/>" alt="team member" />
									<h4>William Hurt</h4>
							...
							<div class="col-sm-6 col-md-3">
								<div class="single-member">
									<img src="<c:url value='/static/resources/images/our-team/member2.jpg'/>" alt="team member" />
							...
							<div class="col-sm-6 col-md-3">
								<div class="single-member">
									<img src="<c:url value='/static/resources/images/our-team/member3.jpg'/>" alt="team member" />
									<h4>Paul Johnson</h4>
							...
							<div class="col-sm-6 col-md-3">
								<div class="single-member">
									<img src="<c:url value='/static/resources/images/our-team/member4.jpg'/>" alt="team member" />
									<h4>John Richerds</h4>
			...
			<div class="container">
				...
				<div class="portfolio-items">
					<div class="col-sm-3 col-xs-12 portfolio-item html">
						<div class="view efffect">
							<div class="portfolio-image">
								<img src="<c:url value='/static/resources/images/portfolio/1.jpg'/>" alt=""></div> 
								<div class="mask text-center">
									<h3>Novel</h3>
									<h4>Lorem ipsum dolor sit amet consectetur</h4>
									<a href="#"><i class="fa fa-link"></i></a>
									<a href="<c:url value='/static/resources/images/portfolio/big-item.jpg'/>" data-gallery="prettyPhoto"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3 col-xs-12 portfolio-item jooma">
							<div class="view efffect" >
								<div class="portfolio-image">
									<img src="<c:url value='/static/resources/images/portfolio/2.jpg'/>" alt="">
								</div> 
								<div class="mask text-center">
									<h3>Novel</h3>
									<h4>Lorem ipsum dolor sit amet consectetur</h4>
									<a href="#"><i class="fa fa-link"></i></a>
									<a href="<c:url value='/static/resources/images/portfolio/big-item4.jpg'/>" data-gallery="prettyPhoto"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
						</div>
						<div class="col-sm-3 col-xs-12 portfolio-item wordpress">
							<div class="view efffect">
								<div class="portfolio-image">
									<img src="<c:url value='/static/resources/images/portfolio/3.jpg'/>" alt="">
								</div> 
								<div class="mask text-center">
								<h3>Novel</h3>
								<h4>Lorem ipsum dolor sit amet consectetur</h4>
					...
					<div class="col-sm-3 col-xs-12 portfolio-item megento">
						<div class="view efffect">
							<div class="portfolio-image">
								<img src="<c:url value='/static/resources/images/portfolio/4.jpg'/>" alt="">
							</div> 
							<div class="mask text-center">
								<h3>Novel</h3>
								<h4>Lorem ipsum dolor sit amet consectetur</h4>
					...
					<div class="col-sm-3 col-xs-12 portfolio-item html">
						<div class="view efffect">
							<div class="portfolio-image">
								<img src="<c:url value='/static/resources/images/portfolio/5.jpg'/>" alt="">
				...
				<div class="col-sm-3 col-xs-12 portfolio-item wordpress">
					<div class="view efffect">
						<div class="portfolio-image">
							<img src="<c:url value='/static/resources/images/portfolio/6.jpg'/>" alt="">
						</div> 
						<div class="mask text-center">
							<h3>Novel</h3>
							<h4>Lorem ipsum dolor sit amet consectetur</h4>
				...
				<div class="col-sm-3 col-xs-12 portfolio-item html">
					<div class="view efffect">
						<div class="portfolio-image">
							<img src="<c:url value='/static/resources/images/portfolio/7.jpg'/>" alt="">
						</div> 
						<div class="mask text-center">
							<h3>Novel</h3>
							<h4>Lorem ipsum dolor sit amet consectetur</h4>
				...
				<div class="col-sm-3 col-xs-12 portfolio-item joomla">
					<div class="view efffect">
						<div class="portfolio-image">
							<img src="<c:url value='/static/resources/images/portfolio/8.jpg'/>" alt=""></div> 
							<div class="mask text-center">
								<h3>Novel</h3>
								<h4>Lorem ipsum dolor sit amet consectetur</h4>
								<a href="#"><i class="fa fa-link"></i></a>
					...
					<div class="col-sm-3 col-xs-12 portfolio-item html">
						<div class="view efffect">
							<div class="portfolio-image">
								<img src="<c:url value='/static/resources/images/portfolio/9.jpg'/>" alt="">
							</div> 
							<div class="mask text-center">
								<h3>Novel</h3>
								<h4>Lorem ipsum dolor sit amet consectetur</h4>
					...
					<div class="col-sm-3 col-xs-12 portfolio-item wordpress">
						<div class="view efffect">
							<div class="portfolio-image">
								<img src="<c:url value='/static/resources/images/portfolio/10.jpg'/>" alt=""></div> 
								<div class="mask text-center">
									<h3>Novel</h3>
									<h4>Lorem ipsum dolor sit amet consectetur</h4>
									<a href="#"><i class="fa fa-link"></i></a>
						...
						<div class="col-sm-3 col-xs-12 portfolio-item joomla">
							<div class="view efffect">
								<div class="portfolio-image">
									<img src="<c:url value='/static/resources/images/portfolio/11.jpg'/>" alt=""></div> 
									<div class="mask text-center">
										<h3>Novel</h3>
										<h4>Lorem ipsum dolor sit amet consectetur</h4>
										<a href="#"><i class="fa fa-link"></i></a>
										<a href="<c:url value='/static/resources/images/portfolio/big-item3.jpg'/>" data-gallery="prettyPhoto"><i class="fa fa-search-plus"></i></a>
									</div>
								</div>
							</div>
							<div class="col-sm-3 col-xs-12 portfolio-item megento">
								<div class="view efffect">
									<div class="portfolio-image">
										<img src="<c:url value='/static/resources/images/portfolio/12.jpg'/>" alt=""></div> 
										<div class="mask text-center">
											<h3>Novel</h3>
											<h4>Lorem ipsum dolor sit amet consectetur</h4>
											<a href="#"><i class="fa fa-link"></i></a>
									...
									<div class="carousel-inner">
										<div class="item active">
											<div class="single-client">
												<div class="media">
													<img class="pull-left" src="<c:url value='/static/resources/images/clients/client1.jpg'/>" alt="">
													<div class="media-body">
										...
										<div class="item">
											<div class="single-client">
												<div class="media">
													<img class="pull-left" src="<c:url value='/static/resources/images/clients/client3.jpg'/>" alt="">
													<div class="media-body">
														<blockquote><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p><small>Someone famous in Source Title</small><a href="">www.yourwebsite.com</a></blockquote>
													</div>
												</div>
										...
										<div class="item">
											<div class="single-client">
												<div class="media">
													<img class="pull-left" src="<c:url value='/static/resources/images/clients/client2.jpg'/>" alt="">
													<div class="media-body">
														<blockquote><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p><small>Someone famous in Source Title</small><a href="">www.yourwebsite.com</a></blockquote>
													</div>
												</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="single-blog">
										<img src="<c:url value='/static/resources/images/blog/1.jpg'/>" alt="" />
										...
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-body">
													...
													<img src="<c:url value='/static/resources/images/blog/3.jpg'/>" alt="" />
													<h2>Lorem ipsum dolor sit amet</h2>
								...
								<div class="col-sm-4">
									<div class="single-blog">
										<img src="<c:url value='/static/resources/images/blog/2.jpg'/>" alt="" />
										<h2>Lorem ipsum dolor sit amet</h2>
										<ul class="post-meta">
											<li><i class="fa fa-pencil-square-o"></i><strong> Posted By:</strong> John</li>
											<li><i class="fa fa-clock-o"></i><strong> Posted On:</strong> Apr 15 2014</li>
	...
	<script type="text/javascript" src="<c:url value='/static/resources/js/smoothscroll.js'/>"></script> 
	<script type="text/javascript" src="<c:url value='/static/resources/js/jquery.isotope.min.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/static/resources/js/jquery.prettyPhoto.js'/>"></script> 
	<script type="text/javascript" src="<c:url value='/static/resources/js/jquery.parallax.js'/>"></script> 
	<script type="text/javascript" src="<c:url value='/static/resources/js/main.js'/>"></script> 
</body>
</html>